...
停止数据库
清空datadir
mariabackup --prepare --target-dir /data/backup/2019-02-21/ --user=xxx --password=xxx
mariabackup --copy-back --target-dir /data/backup/2019-02-21/ --user=xxx --password=xxx
改属主、属组
启动
